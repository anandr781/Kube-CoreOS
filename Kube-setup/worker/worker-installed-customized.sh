...
read -p "The endpoint the worker node should use to contact controller nodes (https://ip:port) : " controller_endpt
echo "Entered CONTROLLER_ENDPOINT  : "$controller_endpt
export CONTROLLER_ENDPOINT=$controller_endpt
